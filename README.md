...
Интерфейс выполнен в премиальном стиле **Frutiger Aero** (стеклянный эффект Aero Glass, глянцевые кнопки, парящие пузыри) с полной поддержкой **тёмной темы** и **локальной истории конвертаций**.
...
- **Тёмная тема** и автоматическое определение типа файлов
...
│   ├── MediaPreview.tsx        # Динамические превью-кадры
│   └── ...
```
